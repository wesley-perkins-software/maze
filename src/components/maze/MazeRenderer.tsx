    ...
    >
      ...
      {showEndpointMarkers && (
        <g style={{ filter: 'drop-shadow(0 1px 2px rgba(15, 23, 42, 0.24))' }}>
          {/* Entry marker — red-coral doorway / entrance glyph */}
          <circle cx={entryMx} cy={entryMy} r={markerBadgeR} fill={MARKER_BADGE_COLOR} />
          <g
            transform={`translate(${entryMx - markerR}, ${entryMy - markerR}) scale(${markerR / 12})`}
            color={START_MARKER_COLOR}
          >
            <path
              d="M7.5 18.5V10.5C7.5 7.8 9.5 5.75 12 5.75C14.5 5.75 16.5 7.8 16.5 10.5V18.5"
              fill="none"
              stroke="currentColor"
              strokeWidth={2.75}
              strokeLinecap="round"
