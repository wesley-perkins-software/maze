...
import { getStartMarkerPath } from '../../lib/maze/markerGeometry';
import {
  FINISH_MARKER_COLOR,
  MARKER_BADGE_COLOR,
  START_MARKER_COLOR,
    ...
    >
      ...
      {showEndpointMarkers && (
        <g style={{ filter: 'drop-shadow(0 1px 2px rgba(15, 23, 42, 0.24))' }}>
          {/* Entry marker — red-coral doorway/entrance badge */}
          <circle cx={entryMx} cy={entryMy} r={markerBadgeR} fill={MARKER_BADGE_COLOR} />
          <path
            d={getStartMarkerPath(entryMx, entryMy, startIconR)}
