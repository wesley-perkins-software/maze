...
function renderSVG(maze: MazeData, cellSize = 10): string {
  ...
  <path d="M${entryCx - r * 0.46},${entryCy + r * 0.5} L${entryCx - r * 0.46},${entryCy - r * 0.42} L${entryCx + r * 0.46},${entryCy - r * 0.42} L${entryCx + r * 0.46},${entryCy + r * 0.5}" fill="none" stroke="${START_MARKER_COLOR}" stroke-width="${Math.max(1, r * 0.18)}" stroke-linecap="round" stroke-linejoin="round"/>
